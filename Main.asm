...
d:  
 MOV AX,0600H       ;06 TO SCROLL & 00 FOR FULLJ SCREEN
    ...
    goto 0,0
 multi              ;calling macro defined for multiplayer
...
MOV AX,0600H    
    ...
    INT 10H        
    goto 0,0  
    single          ;calling macro defined for single player


msg DB "Welcome to Tic Tac Toe", 0Ah, 0Dh, 24h   
singlem DB "1. Single Player Mode", 0Ah, 0Dh, 24h
double DB "2. Multi  Player Mode", 0Ah, 0Dh, 24h  
choice DB "Enter your Choice :", 0Ah, 0Dh, 24h
